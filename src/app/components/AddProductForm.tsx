...
const AddProductForm: React.FC<AddProductFormProps> = ({ onClose }) => {
  ...
  return (
    <div className="relative bg-white border-2 border-gray-200 rounded-lg p-6 max-w-lg w-full mx-auto shadow-xl shadow-purple-500">
      <button
        type="button"
        onClick={onClose}
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
          <button type="submit" className="btn btn-warning w-full lg:w-auto">
            Add Product
          </button>
          <button
            type="button"
